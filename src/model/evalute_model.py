...
from config.settings import PIXEL_TIMESERIES_PATH

csv_path = str(PIXEL_TIMESERIES_PATH)  # Update as needed
...
import os
sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
from config.settings import PEST_MODEL_EVAL_PATH

model = load_model(str(PEST_MODEL_EVAL_PATH))  # Update file name as needed
