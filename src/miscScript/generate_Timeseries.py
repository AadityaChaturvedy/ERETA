...
def main():
    ...
    from config.settings import PEST_MASKS_DIR
    
    parser = argparse.ArgumentParser(description="Pest risk time series vector reporting with debug and progress bars")
    parser.add_argument('--input_folder', type=str, default=str(PEST_MASKS_DIR), help='Folder with refined pest mask TIFFs')
